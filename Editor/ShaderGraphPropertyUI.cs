...
namespace Needle.ShaderGraphMarkdown
{
    internal static class ShaderGraphPropertyUI
    {
        ...
        private static void PollForWindowFocusChanges()
        {
	        ...
	        TryUpdateWindowMarkdown(s_focusedWindow);
        }
#endif

        private static void TryInitializeFocusedWindow() => TryUpdateWindowMarkdown(EditorWindow.focusedWindow);
        ...
        private static void TryUpdateWindowMarkdown(EditorWindow wnd)
        {
            ...
            if (wnd.GetType() != windowType) return;
        ...
        private static void MenuPopulateEvent(ContextualMenuPopulateEvent evt)
        {
            ...
            evt.menu.AppendAction("Refactor Property", dropdownAction =>
            {
                ...
                TryUpdateWindowMarkdown(EditorWindow.focusedWindow);
            });
        }
